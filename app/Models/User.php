 ...
 * @property int $email_visible
 * @property mixed $password
 * @property int $initial_password_changed
 * @property string|null $remember_token
 * @property \Illuminate\Support\Carbon|null $created_at
 * @property \Illuminate\Support\Carbon|null $updated_at
 * @property-read \App\Models\UserDetails|null $details
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\UserJobs> $jobs
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|User whereInitialPasswordChanged($value)
