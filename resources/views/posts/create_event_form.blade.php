<form class="w-full"
    hx-post="{{ route('post.create.execute', ['type' => 'event']) }}">
    @csrf
    ...
    <div class="mt-2 flex items-center justify-between">
        <div class="ml-[56px] flex space-x-2">
            ...
            <button hx-get="{{ route('post.create.form', ['type' => 'event']) }}"
                hx-target="form"
                class="py-1- flex cursor-pointer select-none items-center justify-center rounded-full border border-blue-400 bg-blue-50 px-2"
                type="button">
                <svg width="20"
                    height="20"
                    viewBox="0 0 20 20"
