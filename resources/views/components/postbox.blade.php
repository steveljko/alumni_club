<div id="postbox"
    ...
    <form hx-post="{{ route('post.create.execute', ['type' => 'default']) }}">
        ...
        <div class="flex w-full items-start">
            ...
            <textarea name="body"
                id="postboxTextarea"
                class="leading-1.5 mt-[10px] w-full resize-none text-base font-medium text-gray-700 outline-none"
                placeholder="What is happending?"
                autocomplete="off"></textarea>
        </div>
        <span class="ml-[56px] mt-2 hidden text-sm font-medium text-red-400"
            id="body-validation-message"></span>
        <div class="mt-2 flex items-center justify-between">
            <div id="types"
                class="ml-[56px] flex space-x-2">
                <button class="flex cursor-pointer select-none items-center justify-center rounded-full border border-blue-400 bg-blue-50 px-2 py-1"
                    type="button">
                    <svg width="20"
                        height="20"
                        viewBox="0 0 20 20"
