                        ...
                        <thead class="text-navyblue-500">
                            <tr class="border-b-2 leading-[20px]">
                                <th class="bg-gray-100"
                                    scope="col"></th>
                                <th class="bg-gray-100 px-4 py-2"
                                    scope="col">
                                    Date
                                </th>
                                <th class="bg-gray-100 px-4 py-2"
                                ...
                                <th class="bg-gray-100 px-4 py-2"
                                    scope="col">Type</th>
                                <th class="bg-gray-100 px-4 py-2"
                                    scope="col">Published by</th>
                                <th class="bg-gray-100 px-4 py-2"
                                    scope="col">Comments</th>
                                <th class="bg-gray-100 px-4 py-2 text-right"
                                    scope="col"></th>
                            </tr>
                        </thead>
                        <tbody>
                            @if (isset($posts))
                                @foreach ($posts as $index => $post)
                                    <tr class="border-b border-gray-100 text-gray-700 hover:bg-gray-50"
                                        ...
                                        <td class="w-[1%] whitespace-nowrap p-4 capitalize"
                                            scope="row">
                                            {{ $post->status }}
                                        </td>
                                        <td class="w-[1%] whitespace-nowrap p-4 capitalize"
                                        ...
                                        <td class="whitespace-nowrap p-4"
                                            scope="row">
                                            @if ($post->user != null)
                                                <a class="truncate break-all text-[#003366] hover:underline"
                                        ...
                                        <td class="flex justify-end p-4"
                                            scope="row">
                                            <x-button id="view-post"
                                                hx-get="{{ route('admin.posts.show', $post) }}"
                                                hx-target="#wrapper"
                                                hx-swap="outerHTML"
                                                hx-push-url="true">View</x-button>
                                        </td>
                                    </tr>
                                @endforeach
                            @endif
